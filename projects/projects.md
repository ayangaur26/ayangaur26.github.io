...
### 1. Self-driving Software for GEM e4 (In progress) 
Performing camera-LiDAR calibration, 3D mapping, and implementing BEV (Bird’s Eye View) perception and forecasting models.

### 2. Self-Balancing Biped (In progress)
Architecting an embedded system on an ESP32 that fuses Gyroscope and ToF data to maintain stability while processing Lidar/Camera inputs.
...
### 4. [Agentic Resume Generator](https://resume-updater-one.vercel.app/)
...
### 6. [Coffee dialing-in assistant](https://coffee-dial-in.vercel.app/)
...
### 7. [TritonMates – Full-Stack Roommate Management App](https://github.com/a2jensen/CSE-110-TritonMates)
...
### 8. [User Rating Prediction Recommender System and Research Paper](https://drive.google.com/file/d/1jTe1jFSHnlCgZ76BHsqI3kpLeLlQJZ5O/view?usp=drive_link)
...
### 10. Huffman Encoding Tree for File Compression
